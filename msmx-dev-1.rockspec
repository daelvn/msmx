...
build = {
  ...
  modules = {
    ...
    ["msmx.import-std"]        = "msmx/import-std.lua",
    ["msmx.import-simple-all"] = "msmx/import-simple-all.lua",
    ...
    ["msmx.pragma"]            = "msmx/pragma.lua",
    ["msmx.where"]             = "msmx/where.lua",
    ["msmx.oversign"]          = "msmx/oversign.lua",
  },
  install = {
    bin = {
     msmx = "bin/msmx.lua"
